...
const welcomeImg = "../images/najm.png";
const shareUrlImg = "../images/najm.png";
const leaveRoomImg = "../images/leave-room.png";
const confirmImg = "../images/najm.png";
const fileSharingImg = "../images/najm.png";
...
const aboutImg = "../images/poster.png";
...
function setButtonsToolTip() {
  ...
  setTippy(shopBtn, "Go to marketplace", "right-start");
  setTippy(bitcoinBtn, "Show bitcoin wallet", "right-start");
  setTippy(flashBtn, "Take screenshot", "right-start");
...
function showAbout() {
  ...
  Swal.fire({
    background: swalBackground,
    position: "center",
    title: "<strong>Liiska</strong>",
    imageAlt: "About",
    imageUrl: aboutImg,
    html: `
        <br/>
        <div id="about">
            <b style="color:orange">Open Source</b> project on
            <a href="https://github.com/yd-915/liipro" target="_blank"><br/></br>
            <img alt="Github" src="../images/github.png"></a><br/><br/>
        </div>
        </br>
        <div id="author">Original Project : <a href="https://github.com/jaideep25/videolify" target="_blank"> Here</a></div>
        `,
    showClass: {
      popup: "animate__animated animate__fadeInDown",
    },
